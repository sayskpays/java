...
//        memberTreeSet.showAllMember();
        ...
        MemberVO vo_test1 = new MemberVO("김");
        MemberVO vo_test2 = new MemberVO("님");
        MemberVO vo_test3 = new MemberVO("딤");

        memberTreeSet.addMember(vo_test1);
        memberTreeSet.addMember(vo_test2);
        memberTreeSet.addMember(vo_test3);
